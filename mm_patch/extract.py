...
def extract_patches_2d(image, patch_size, max_patches=None, random_state=None, patch_filter=None):
    ...
    if max_patches:
        ...
        if patch_filter:
            ...
            i_s = []
            j_s = []
            while ok_patches < n_patches:
                i_global = rng.randint(i_h - p_h + 1, size=1)
                j_global = rng.randint(i_w - p_w + 1, size=1)
